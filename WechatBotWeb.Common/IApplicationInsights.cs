namespace WechatBotWeb.Common
{
    ...
    public interface IApplicationInsights
    {
        ...
        //Task<T> WatchDependencyAsync<T>(Func<Task<T>> func, Action<T, IApplicationInsightEvent> checkResult, string source, params string[] properties);
        ///// <summary>
        ...
        //Task WatchDependencyAsync(Func<Task> func, string source, params string[] properties);
        ///// <summary>
        ...
        //T WatchDependency<T>(Func<T> func, Action<T, IApplicationInsightEvent> checkResult, string source, params string[] properties);
        ///// <summary>
        ///// watch code snippet without a return value
        ///// </summary>
        ///// <param name="action">code snippet</param>
        ///// <param name="properties">additional data for the watch</param>
        //void WatchDependency(Action action, string source, params string[] properties);
        ...
        ///// <param name="properties">additional data for the watch</param>
        ///// <returns>return value of func</returns>
        //Task<T> WatchDependencyAsync<T>(Func<IApplicationInsightEvent, Task<T>> func, string source, params string[] properties);
        ///// <summary>
        ///// watch task code snipppet without a return value
        ///// </summary>
        ///// <param name="func">code snippet</param>
        ///// <param name="properties">additional data for the watch</param>
        ///// <returns>a task value of func</returns>
        //Task WatchDependencyAsync(Func<IApplicationInsightEvent, Task> func, string source, params string[] properties);
        ///// <summary>
        ///// watch code snippet with a return value
        ///// </summary>
        ///// <typeparam name="T">return value type</typeparam>
        ...
        ///// <param name="properties">additional data for the watch</param>
        ///// <returns>return value of code snippet</returns>
        //T WatchDependency<T>(Func<IApplicationInsightEvent, T> func, string source, params string[] properties);
        ///// <summary>
        ///// watch code snippet without a return value
        ///// </summary>
        ///// <param name="action">code snippet</param>
        ///// <param name="properties">additional data for the watch</param>
        //void WatchDependency(Action<IApplicationInsightEvent> action, string source, params string[] properties);
